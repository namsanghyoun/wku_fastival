...
$('.btn1').on('click', function(){
     ...
     $('.btn1').css("color","#1f2a59");
     $(this).css("background-color","#1f2a59");
     $(this).css("border-color","#1f2a59");
...
$('.btn2').on('click', function(){
     ...
     $('.btn2').css("color","#bd2025");
     $(this).css("background-color","#bd2025");
     $(this).css("border-color","#bd2025");
     $(this).css("color","#fff");
...
var options = {
	center: new daum.maps.LatLng(35.968674, 126.956963),
	level: 1
};
...
var positions = [  // 마커의 위치
     {
        title: '컴공', 
        latlng: new daum.maps.LatLng(35.968768, 126.957099),
        content: '<div style="padding:5px;">a!</div>',
        sw: new daum.maps.LatLng(35.968647, 126.956963), // 사각형 영역의 남서쪽 좌표
        ne: new daum.maps.LatLng(35.968829, 126.957276),
        color:"#FF8AEF"
     },
     {
        title: '메롱', 
        latlng: new daum.maps.LatLng(35.968712, 126.957504),
        content: '<div style="padding:5px;">Hello World!</div>',
        sw: new daum.maps.LatLng(35.968657, 126.957379), // 사각형 영역의 남서쪽 좌표
        ne: new daum.maps.LatLng(35.968787, 126.957612),
        color:"#fff"
     }
...
var sw = new daum.maps.LatLng(35.968647, 126.956963), // 사각형 영역의 남서쪽 좌표
    ne = new daum.maps.LatLng(35.968829, 126.957276); // 사각형 영역의 북동쪽 좌표
...
function addMarker(position, normalOrigin, overOrigin, clickOrigin,content,id) {
    ...
    var marker = new daum.maps.Marker({
     ...
     var infowindow = new daum.maps.InfoWindow({
             content: '<div style="text-align:center;padding:3px;">'+content+'</div>' // 인포윈도우에 표시할 내용
         });
